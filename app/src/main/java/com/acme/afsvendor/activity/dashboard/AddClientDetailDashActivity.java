...
import com.acme.afsvendor.databinding.ActivityAddClientDetailDashBinding;
...
public class AddClientDetailDashActivity extends AppCompatActivity implements ApiInterface {
    private ActivityAddClientDetailDashBinding binding;
    String response1;
    String logintoken;
    String clientid;
    int apicall;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        binding = ActivityAddClientDetailDashBinding.inflate(getLayoutInflater());
